...
echo ""
echo "✅ Всё готово! Маршруты будут добавляться при каждой загрузке системы."
echo "   Управление службой:"
echo "   sudo systemctl status add-my-routes.service  # статус"
echo "   sudo systemctl restart add-my-routes.service # перезапустить"
echo "   sudo systemctl disable add-my-routes.service # отключить автозагрузку"